function setup(){
    ...
    H.position(425,10)
    A=createElement("h1")
    A.html("Let`s see if you can answer this simpleee ")
    A.position(300,50)
    B=createElement("h1")
    B.html("Question ")
    B.position(425,100)
    ...
    D.position(50,250)
    E=createElement("h2")
    E.html("b)Ram Nath Kovind ")
    E.position(50,300)
    G=createElement("h2")
    G.html("c) Emmanuel Macron")
    G.position(50,350)
    I=createElement("h2")
    I.html("d) Moon Jae-in")
    I.position(50,400)
    bp=createButton("SUBMIT")
    bp.position(100,550)
    ...
    E.position(100,400)
    D=createElement("h1")
    D.html("THANK YOU !! PLS COME AGAIN TO PLAY")
    D.position(50,500)
    }
